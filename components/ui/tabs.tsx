// shadcn/ui Tabs — built on Radix Tabs (keyboard nav + ARIA handled). Note these
// are Client Components, but their children can be server-rendered content, so a
// Server Component page can still compose <Tabs> with server children.
"use client";
