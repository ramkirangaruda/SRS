// shadcn/ui Card — a set of small composable pieces (Card, CardHeader,
// CardTitle, CardContent, ...) that together form a styled "card" container.
// We'll use these on the dashboards and the login form.
