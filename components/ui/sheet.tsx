// shadcn/ui Sheet — a slide-over panel built on Radix Dialog. Same accessibility
// as Dialog (focus trap, Escape, ARIA) but slides in from an edge. We use the
// right side for the "Add Payment" panel. cva defines the per-side animation.
"use client";
